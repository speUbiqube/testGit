...
$object_parameters['spyware_shared_profile'] = '0';


$response = execute_command_and_verify_response($device_id, "IMPORT", $object_parameters, "IMPORT spyware_shared_profile");
