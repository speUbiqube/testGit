...
require_once load_once('qa_da_import', 'qa_da_import_connect.php');
require_once load_once('qa_da_import', 'apply_errors.php');
require_once "$db_objects";

function qa_da_import_apply_conf($configuration) {
    global $sdid;
    global $sms_sd_ctx;
    global $sms_sd_info;
