...
require_once load_once('qa_da_import', 'common.php');
require_once load_once('qa_da_import', 'adaptor.php');
require_once load_once('qa_da_import', 'qa_da_import_apply_conf.php');
// require_once load_once('qa_da_import', 'qa_da_import_apply_restore_conf.php');

require_once "$db_objects";

class qa_da_import_configuration {
    ...
    function update_conf() {
        ...
        if (! empty($generated_configuration)) {
            $ret = qa_da_import_apply_conf($generated_configuration);
        }
