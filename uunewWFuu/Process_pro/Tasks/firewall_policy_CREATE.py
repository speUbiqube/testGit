...
dev_var.add('firewall_policy.0.source_ip', var_type='ObjectRef')
dev_var.add('firewall_policy.0.source_int_zone', var_type='ObjectRef')
dev_var.add('firewall_policy.0.dest_ip', var_type='ObjectRef')
dev_var.add('firewall_policy.0.dest_int_zone', var_type='ObjectRef')
dev_var.add('firewall_policy.0.service', var_type='ObjectRef')
dev_var.add('firewall_policy.0.action', var_type='String')
dev_var.add('firewall_policy.0.options', var_type='String')
